...
for qu in range(len(lineQ)):
    ...
    if dl == True and du == True and e == True and u == True and "user:" in lineQ[qu]:
        ...
        msg['Subject'] = "You are reaching your data limit!"
        msg['From'] = "intern@fused.com"
        msg['To'] = email

        msgText = MIMEText("\n\nHello! You are recieving this message because you have come within 5% of your data limit. \n\n We have raised your limit by 2% free of charge. If you would like to increase your data limit, please visit www.fused.com.")

        file = open("alert.html", 'rb')
        img = MIMEImage(file.read(), 'html')
